...
student1 = Student('Ivan', 'Ivanov', ['Python'], ['Введение в программирование'])
student2 = Student('Alex', 'Smirnov', ['Python'])

lecturer1 = Lecturer('Nikolay', 'Petechkin', ['Python'])
lecturer2 = Lecturer('Mari', 'Sidorova', ['Python'])

reviewer1 = Reviewer('Dima', 'Kovalev', ['Python'])
reviewer2 = Reviewer('Olga', 'Ivanova', ['Python'])
